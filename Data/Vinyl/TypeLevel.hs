...
-- class AllConstrained c (ts :: [k]) where
-- instance AllConstrained c '[] where
-- instance (c t, AllConstrained c ts) => AllConstrained c (t ': ts) where
...
-- class AllSatisfied cs (t :: k) where
...
-- class AllAllSat cs (ts :: [k]) where
-- instance AllAllSat cs '[] where
-- instance (AllSatisfied cs t, AllAllSat cs ts) => AllAllSat cs (t ': ts) where
